...
//- Frame 1 ----------------------------------------------------------->
	...
	tl.from("#frame1-copy", time, {autoAlpha:0});
	tl.from("#frame1-image", time, {autoAlpha:0},"-="+between);

	tl.to("#frame1-copy", time, {delay:wait, autoAlpha:0});
	tl.to("#frame1-image", time, {autoAlpha:0},"-="+between);
...
//- Frame 3 ----------------------------------------------------------->
	...
	tl.from("#frame3-copy", time, {autoAlpha:0, onComplete:loopCheck});

	tl.to("#frame3-copy", time, {delay:wait, autoAlpha:0});
